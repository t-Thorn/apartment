            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">添加房间信息</div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="card-head">
                                <header>添加房间信息</header>
                            </div>
                            <form name="add" action="/Room?param=4" method="post">
                                <div class="card-body row">
                                    ...
                                    <div class="col-lg-6 p-t-20">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            ...
                                            <label for="list1"
                                                   class="mdl-textfield__label">房间人数</label>
                                    ...
                                    <div class="col-lg-6 p-t-20">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            <input class="mdl-textfield__input" type="text" id=
                                                    "Hire_Money" name="hiremoney">
                                            <label class="mdl-textfield__label">租金</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 p-t-20">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            <input class="mdl-textfield__input" type="text" id=
                                                    "things" name="things">
                                            <label class="mdl-textfield__label">房间设施</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 p-t-20">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                    ...
                                    <div class="col-lg-12 p-t-20">
                                        <div id="id_dropzone" class="dropzone">
                                            <label class="control-label col-md-3">上传房间照片</label>
...
<script>
    function check() {
        htmlobj = $.ajax({
            ...
            url: "/Ajax?param=1&value=" + $("#Room_Num").val(),
            async: false
        });
        $("#tip").html(htmlobj.responseText);
    }
