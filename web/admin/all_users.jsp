            ...
            <div class="page-content">
                ...
                <ul class="nav nav-pills nav-pills-rose">
                    <li class="nav-item tab-all"><a class="nav-link active show"
                                                    href="#tab1" data-toggle="tab">用户列表</a></li>
                                        ...
                                        <div class="table-scrollable">
                                            <table class="table table-hover table-checkable order-column full-width"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center">${row.getUser_Name()}</td>
                                                    <td class="center">
                                                        <c:choose>
                                                            <c:when test="${row.getUser_Role()==1}">
                                                                管理员
                                                            </c:when>
                                                            <c:otherwise>
                                                                用户
                                                    ...
                                                    <td class="center">${row.getUser_Tel()}</td>
                                                    <td class="center">${row.getUser_Account()}</td>
                                                    <td class="center">${row.getUser_ID()}</td>
                                                    <c:choose>
                                                        <c:when test="${row.getBalance()>=0}">
                                                            <td class="center">
                                                                <p>${row.getBalance()}</p></td>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <td class="center"><p
                                                                    style="color:red">${row.getBalance()}</p>
                                                            </td>
                                                        </c:otherwise>
                                                    </c:choose>
                                                    ...
                                                    <td class="center">
                                                        <a
                                                                href="/User?cz=view&userid=${row.getUser_ID()}"
                                                                class="btn btn-tbl-edit btn-xs">
                                                            <i class="fa fa-pencil"></i>
                                                        </a><a
                                                            href="/User?cz=del&userid=${row.getUser_ID()}"
