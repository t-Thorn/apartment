		...
		<div class="page-container">
					...
					<div id="remove-scroll">
						<ul class="sidemenu page-header-fixed p-t-20"
							...
							<li class="nav-item start "><a href="#"
								...
								<ul class="sub-menu">
									<li class="nav-item "><a href="/Analyse"
										class="nav-link "> <span class="title">分析</span> <span
											class="selected"></span>
									</a></li>
								</ul></li>
							...
							<li class="nav-item"><a href="#" class="nav-link nav-toggle">
								...
								<ul class="sub-menu">
									<li class="nav-item"><a href="new_booking.jsp"
							...
							<li class="nav-item "><a href="#"
								...
								<ul class="sub-menu">
									<li class="nav-item "><a href="add_room.jsp"
										class="nav-link "> <span class="title">添加房间</span>
									</a></li>
									<li class="nav-item ">
							...
							<li class="nav-item"><a href="#" class="nav-link nav-toggle">
									<i class="material-icons">group</i> <span class="title">房客</span>
									<span class="arrow"></span>
							</a>
								<ul class="sub-menu ">
									<li class="nav-item "><a href="add_staff.jsp"
										class="nav-link "> <span class="title">添加房客</span>
									</a></li>
									<li class="nav-item "><a href="SS?cz=view"
										class="nav-link "> <span class="title">查看所有房客</span>
									</a></li>
									<li class="nav-item "><a href="edit_staff.jsp"
										class="nav-link "> <span class="title">修改房客信息</span>
									</a></li>
								</ul></li>
							<li class="nav-item active"><a href="#"
								...
								<ul class="sub-menu">
									<li class="nav-item"><a href="add_user.jsp"
										class="nav-link "> <span class="title">添加用户</span>
									</a></li>
									<li class="nav-item "><a href="/User?cz=view"
										class="nav-link "> <span class="title">查看所有用户</span>
									</a></li>
								</ul></li>
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<form method="post" action="/User?cz=u" id="form1">
								...
								<div class="card-box">
									...
									<div class="col-lg-6 p-t-20">
										...
										<div class="col-lg-6 p-t-20">
											<div
												...
												<input class="mdl-textfield__input" type="text" id="type"
													readonly tabIndex="1" name="type"> <label
													for="type" class="pull-right margin-0"> <i
													class="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
												</label> <label for="type" class="mdl-textfield__label">用户类型</label>
												<ul data-mdl-for="type"
													class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
													<li class="mdl-menu__item" data-val="DE">管理员</li>
													<li class="mdl-menu__item" data-val="BY">用户</li>
												</ul>
											</div>
										</div>
										<div class="col-lg-6 p-t-20">
										...
										<div class="col-lg-6 p-t-20">
											<div
												...
												<input class="mdl-textfield__input" type="text"
													...
													value="${user[0].getAdd_Time() }"> <label
													class="mdl-textfield__label">添加日期</label>
											</div>
										</div>
										<div class="col-lg-6 p-t-20">
											<div
												...
												<input class="mdl-textfield__input" type="text" id="Address"
													name="id" value="${user[0].getUser_ID()}"> <label
										...
										<div class="col-lg-6 p-t-20">
											<div
												class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
												<input class="mdl-textfield__input" type="text" id="Balance"
													name="Balance" value="${user[0].getBalance()}"> <label
													class="mdl-textfield__label">余额</label>
