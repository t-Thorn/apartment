...
<head>
    ...
    <link rel="stylesheet" href="/userlogin/lib/layui/css/layui.css" media="all"/>
    <link rel="stylesheet" href="/userlogin/css/login.css"/>
    <link rel="stylesheet" href="/userlogin/css/tooltips.css"/>


    <script type="text/javascript" src="/userlogin/js/jquery.min.js"></script>
    <script type="text/javascript" src="/userlogin/js/jquery.pure.tooltips.js"></script>
    <script type="text/javascript" src="/userlogin/lib/layui/layui.js"></script>
    <style>
        body {
            margin: 0;
            padding: 0;
    ...
    <script >
      if(window.name != "bencalie"){
            ...
            window.name = "";
            if(${UID!=null})
                window.location.href="/User?cz=dl";
    }
    </script>
</head>
<body>
...
<div class="beg-login-box box box-login layui-anim-up" id="login">
    ...
    <div class="beg-login-main">
        <form action="/User?cz=dl" class="layui-form" method="post" id="login1"><input
            ...
            <div class="layui-form-item">
                ...
                <input id="username" type="text" name="userName" lay-verify="userName"
            ...
            <div class="layui-form-item">
                <div class="beg-pull-left beg-login-remember"
                     style="color:#FFFFFF;margin-top: -2%;">
                    <button class="layui-btn layui-btn-radius layui-btn-primary"
                            onclick="goto_register();return false;">
                        <i class="layui-icon">&#xe650;</i> 注册
                    </button>
                </div>

                <div class="beg-pull-right">
                    <button class="layui-btn layui-btn-radius" style="margin-top: 4%;"
...
<div class="beg-login-box box box-register layui-anim-rotate" id="register">
    ...
    <div class="beg-login-main">
        <form action="/User?cz=ur" class="layui-form" method="post"><input
                name="__RequestVerificationToken" type="hidden"
                value="fkfh8D89BFqTdrE2iiSdG_L781RSRtdWOH411poVUWhxzA5MzI8es07g6KPYQh9Log-xf84pIR2RIAEkOokZL3Ee3UKmX0Jc8bW8jOdhqo81"/>
            <div class="layui-form-item">
                <label class="beg-login-icon">
                ...
                <input id="username_register" type="text" name="userName" lay-verify="userName"
            ...
            <div class="layui-form-item">
                ...
                <input id="password_register" type="password" name="password" lay-verify="password"
                       autocomplete="off" placeholder="请输入密码" class="layui-input">
            </div>
            <div class="layui-form-item">
                <label class="beg-login-icon">
                ...
                <input id="determine_password_register" type="password" name="password"
                       lay-verify="password" autocomplete="off" placeholder="确认密码"
                       class="layui-input">
            </div>
            <div class="layui-form-item">
                <label class="beg-login-icon">
                ...
                <input id="userid" type="text" name="User_id" autocomplete="off"
